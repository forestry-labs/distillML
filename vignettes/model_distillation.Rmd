...
* `snap.train`: This argument takes a boolean value and determines if we make approximations 
                ...
                the surrogate model uses the marginal distirbution of the subsampled training 
...
the sparse modell tend to be smaller than in the original distilled model.
