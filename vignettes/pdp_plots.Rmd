...
We can also include the ICE lines within the PDP plots by changing the method in the plotting function.
```{r, echo=TRUE}
pdp_plots <-  plot(forest_interpret, method = "pdp+ice", features = "Sepal.Width")
plot(pdp_plots$Sepal.Width)
```
